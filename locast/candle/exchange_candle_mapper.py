...
class ExchangeCandleMapper:
    """
    A class that maps dictionaries representing candles from different exchanges to Candle objects.
    """
    ...
    def dicts_to_candles(
        ...
        return [
            ExchangeCandleMapper.dict_to_candle(exchange, candle_dict)
            for candle_dict in candle_dicts
        ]

    @staticmethod
    def dict_to_candle(exchange: Exchange, candle_dict: Dict[str, Any]) -> Candle:
